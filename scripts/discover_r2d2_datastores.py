...
Examples:
    python scripts/discover_r2d2_datastores.py
    python scripts/discover_r2d2_datastores.py --platform nccs_discover_sles15
    python scripts/discover_r2d2_datastores.py --platform nccs_discover_sles15 --server gmao
"""
...
def main():
    ...
    print('\nNote: datastores are physical storage locations (a Discover directory')
    print('or an S3 bucket), not experiment lifetimes (debug/science/release).')
    print('\nTo target a specific datastore, set in experiment.yaml:')
