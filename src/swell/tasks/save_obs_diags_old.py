...
class SaveObsDiags(taskBase):
    ...
    def execute(self) -> None:
        ...
        for observation in observations:
            ...
            # Print out all arguments before calling check_obs
            print("Arguments for check_obs:")
            print(f"observing_system_records_path: {self.jedi_rendering.observing_system_records_path}")
            print(f"observation: {observation}")
            print(f"observation_dict: {observation_dict}")
            print(f"cycle_time_dto: {self.cycle_time_dto()}")
