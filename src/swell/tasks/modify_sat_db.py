...
from swell.utilities.satbd_utils import run_sat_db_process
import itertools
import yaml
        ...
        for ob in obs:
            ...
            if '_' in name:
                ...
                try:
                        ...
                        with open(sat_db_yaml_loc + sat + '.yaml', 'r') as file:
                            ...
                            for ind in range(len(instr_dict)):
                                ...
                                begin = dt.strptime(instr_dict[ind]['begin date'],
                                                    '%Y-%m-%dT%H:%M:%S')
                                end = dt.strptime(instr_dict[ind]['end date'],
                                                  '%Y-%m-%dT%H:%M:%S')
                    ...
                    print('satellite {} and instrument {} are not in the satellite database'
                          .format(sat, instr))
                    continue
