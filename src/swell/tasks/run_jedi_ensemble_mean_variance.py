...
class RunJediEnsembleMeanVariance(taskBase):
    ...
    def execute(self) -> None:
        ...
        # Ensemble
        self.jedi_rendering.add_key('ensemble_num_members', self.config.resolve(ensemble_num_members, default=None))

        self.logger.info(f'ensmeanvariance_spec = {self.config.resolve(ensmeanvariance_spec)}')
        meanvar_spec_dict = self.config.resolve(ensmeanvariance_spec)
