...
class EvaIncrement(taskBase):
    ...
    def execute(self) -> None:
        ...
        window_begin_dto = self.da_window_params.window_begin(self.config.resolve(window_length),
                                                              dto=True)
        ...
        local_bkg_dir, local_bkg_dto = self.da_window_params.local_background_time(
            self.config.window_length(), self.config.resolve(window_length), dto=True)
