...
class PrepCoupledGeosRunDir(taskBase):
    ...
    def execute(self) -> None:
        ...
        if self.config.resolve(qd.geos_expdir_different):
            self.geos_expdir = os.path.join(self.experiment_path(), 'GEOSgcm', 'GEOS_expdir')
        else:
            self.geos_expdir = self.geos_homdir

        self.geos_build = self.config.resolve(qd.existing_geos_gcm_build_path)
        ...
        # -------------------------------------------------------------
        self.forecast_duration = self.config.resolve(qd.forecast_duration)
    ...
    def mom6_iau(self) -> None:
        ...
        # --------------------------------------------------------------------------
        if self.config.resolve(qd.get_key_for_model, default='mom6_iau', 'geos_marine', False):
...
self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)mself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)oself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)mself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)6self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)_self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)iself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)aself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)uself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)_self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)nself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)hself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)oself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)uself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)rself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)sself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)=self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)sself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)eself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)lself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)fself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',).self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)cself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)oself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)nself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)fself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)iself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)gself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',).self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)gself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)eself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)tself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)_self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)kself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)eself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)yself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)_self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)fself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)oself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)rself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)_self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)mself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)oself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)dself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)eself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)lself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)(self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)'self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)mself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)oself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)mself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)6self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)_self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)iself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)aself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)uself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)_self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)nself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)hself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)oself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)uself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)rself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)sself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)'self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',),self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',) self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)'self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)gself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)eself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)oself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)sself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)_self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)mself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)aself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)rself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)iself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)nself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)eself.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)'self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',),self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)
self.config.resolve(qd.get_key_for_model, default='mom6_iau_nhours', 'geos_marine',)                                                                'PT50D')
    ...
    def rewrite_cap(self, rcdict: dict, rcfile: str) -> dict:
        ...
        [time_string, days, _] = self.geos.iso_to_time_str(self.config.resolve(qd.forecast_duration))
