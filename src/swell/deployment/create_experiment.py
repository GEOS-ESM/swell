...
def prepare_config(
    ...
    # -------------------------------
    if 'r2d2_experiment_id' in experiment_dict and 'store_r2d2' in experiment_dict \
            and experiment_dict['store_r2d2']:
...
def create_experiment_directory(
    ...
    if store_r2d2:
        ...
        override['store_r2d2'] = store_r2d2
