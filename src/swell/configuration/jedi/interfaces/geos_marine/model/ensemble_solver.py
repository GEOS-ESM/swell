...
def ensemble_solver(template_dict: Mapping) -> Mapping:
    ...
    local_ensemble_inflation_rtps = template_dict.get('local_ensemble_inflation_rtps', 0.0)
    local_ensemble_inflation_rtpp = template_dict.get('local_ensemble_inflation_rtpp', 0.0)
    local_ensemble_inflation_mult = template_dict.get('local_ensemble_inflation_mult', 1.0)
