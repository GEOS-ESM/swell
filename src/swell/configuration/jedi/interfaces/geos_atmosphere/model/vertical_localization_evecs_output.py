...
def vertical_localization_evecs_output(template_dict: Mapping) -> Mapping:
    ...
    vertical_localization_evecs_output = {
        'filetype': 'auxgrid',
        'gridtype': 'latlon',
        'filename': f'{cycle_dir}/vert_localization_evecs%{{member}}%-inc',
        'field io names': {
            'eastward_wind': 'ua',
            'northward_wind': 'va',
            'air_temperature': 't',
    ...
    return vertical_localization_evecs_output
