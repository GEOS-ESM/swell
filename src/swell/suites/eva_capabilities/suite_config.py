...
suite_configs.register(suite_name, 'eva_capabilities', eva_capabilities)
...
suite_configs.register(suite_name, 'eva_capabilities_atmosphere', eva_capabilities_atmosphere)
